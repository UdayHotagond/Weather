...
def getWeather():
    ...
    try:
        ...
        if not location:
            raise ValueError("invalid entry. check city name")
...
# search box
Search_image = PhotoImage(file="C:/Users/Uday/OneDrive/Desktop/weather/sea.png")
...
Search_icon = PhotoImage(file="C:/Users/Uday/OneDrive/Desktop/weather/search_icon.png")
...
# logo
Logo_image = PhotoImage(file="C:/Users/Uday/OneDrive/Desktop/weather/logo.png")
myimage = Button(image=Logo_image)
myimage.place(x=150, y=100)

# Bottom box
Frame_image = PhotoImage(file="C:/Users/Uday/OneDrive/Desktop/weather/box.png")
